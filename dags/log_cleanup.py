...
DEFAULT_MAX_LOG_AGE_IN_DAYS = Variable.get("airflow_log_cleanup__max_log_age_in_days", 1)
...
ENABLE_DELETE_CHILD_LOG = (
    "True"  # Variable.get("airflow_log_cleanup__enable_delete_child_log", "True")
)
